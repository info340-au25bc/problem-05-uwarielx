...
const containsCool = motto.indexOf("cool") !== -1;
...
console.log(shapes[shapes.length - 1].hypotenuse);
// I get `undefined` because the hypotenuse property does not exist yet.
...
console.log(shapes);
// The previous logged array in the console will show the up-to-date value when expanded.
