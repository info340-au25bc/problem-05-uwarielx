...
let opponentsLostTo = lostGames.map(extractOpponent);
console.log(opponentsLostTo);
...
const gamesWithFumbles = huskyGames2016.filter(game => game.fumbles > 0);
...
let fumbledAndLostFilter = makeCombinedFilter(huskiesLost, game => game.fumbles > 0);
